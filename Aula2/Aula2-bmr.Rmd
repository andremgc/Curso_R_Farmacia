...
1. Crie irisMolten, uma versão _molten_ de iris, isto é, que tenha uma coluna com multiplas variáveis. Com as colunas _Species_, _Variable_ e _Value_.

2. A partir de irisMolten, crie um _data frame_ _Tidy_, como o original.

1. Crie iris2, que seja iguala iris, mas com novas colunas:
    a. __Sepal.Ratio__: Igual à divisão de __Sepal.Length__ e __Sepal.Width__.
    b. __Petal.Ratio__: Igual à divisão de __Petal.Length__ e __Petal.Width__.

2. Verifique a média das colunas criadas.

3. Verifique a média das colunas criadas, extratificando por __Species__. Discuta se há diferença.

4. Verifique o tamanho da amostra para cada __Species__.
